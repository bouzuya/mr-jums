...
test('model > entry-viewer > selectNext', () => {
  ...
  const next10 = new Array(10).fill(0).reduce((e, _) => e.selectNext(), next0);
  ...
  const next30 = new Array(30).fill(0).reduce((e, _) => e.selectNext(), next0);
  ...
  const next31 = new Array(31).fill(0).reduce((e, _) => e.selectNext(), next0);
