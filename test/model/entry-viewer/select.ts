...
test('model > entry-viewer > select', () => {
  ...
  const focus20160131 = data.select('2016-01-31');
  ...
  const focus20160121 = data.select('2016-01-21');
  ...
  const focus20160101 = data.select('2016-01-01');
  ...
  const focus19700101 = data.select('1970-01-01'); // not found
