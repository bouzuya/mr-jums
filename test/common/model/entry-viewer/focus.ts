...
import { focus } from '../../../../src/common/model/entry-viewer';
...
test('/common/model/entry-viewer/focus', () => {
  ...
  assert(focus20160131.filteredEntries.length === 9);
  ...
  assert(focus20160121.filteredEntries.length === 9);
  ...
  assert(focus19700101.filteredEntries.length === 9);
